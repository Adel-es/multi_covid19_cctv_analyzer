...
input_video_path        = "proj/data/input/testVideo.mp4"
query_image_path        = "proj/data/input/query/" # query image의 이름은 "숫자_숫자_숫자" 로 설정. ex) 1_0_0.jpg
output_video_path       = "proj/data/output/testVideo.avi"
output_json_path        = "proj/data/output/analysis/testVideo.json"
