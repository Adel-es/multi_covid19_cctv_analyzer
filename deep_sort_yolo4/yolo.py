...
print(f"yolo path: {path}")

class YOLO(object):
    def __init__(self):
        self.model_path = f'{path}/model_data/yolo4.h5'
        self.anchors_path = f'{path}/model_data/yolo_anchors.txt'
        self.classes_path = f'{path}/model_data/coco_classes.txt'
        self.gpu_num = 1
        self.score = 0.5
        self.iou = 0.5
